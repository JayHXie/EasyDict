package com.jayhxie.easydict.adapter.settings
...
class AppUpdateDataAdapter(private val appUpdateDataItems: ArrayList<AppUpdateDataItem>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvDownloadInNetdisk.setOnClickListener {
            val url = "https://pan.quark.cn/s/1b2c01e13ff3"
            WebActivity.start(holder.itemView.context, url)
            ClipboardUtils.copyTextToClipboard(holder.itemView.context, "p2cg", holder.itemView.context.getString(R.string.pwd_eee, "p2cg"))
        }
